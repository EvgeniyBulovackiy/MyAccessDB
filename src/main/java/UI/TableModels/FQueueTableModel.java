...
import DAO.ModelDAO.FData2QueueDAO;
import models.*;
...
public class FQueueTableModel extends AbstractTableModel {
  private String[] columnNames = new String[]{
    ...
    "Тип сигнала", "Коментарий", "Клемма контроллера"
  };
  private List<FData2Queue> listData;
  private DataDAO dataDAO;
  private TreePath treePath;

  public FQueueTableModel(List<FData2Queue> listData, DataDAO dataDAO, TreePath treePath) {
  ...
  public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
    FData2Queue data = listData.get(rowIndex);
  ...
  public void addRow(){
    FData2Queue newData = new FData2Queue();
  ...
  public void deleteRow(int row){
    FData2Queue data = listData.get(row);
    listData.remove(row);
    dataDAO.delete(data);
